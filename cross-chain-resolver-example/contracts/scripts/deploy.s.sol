...
contract DeployScript is Script {
    function run() public returns (address escrowFactory, address resolver) {
        ...
        address mockLimitOrderProtocol = address(0x1111111111111111111111111111111111111111);
        IERC20 mockFeeToken = IERC20(address(0x2222222222222222222222222222222222222222));
        IERC20 mockAccessToken = IERC20(address(0x3333333333333333333333333333333333333333));
