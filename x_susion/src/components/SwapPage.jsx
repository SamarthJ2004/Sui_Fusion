...
const chains = ["sui", "ethereum"];
const tokens = { 
  sui: [{ symbol: "SUI", name: "Sui", price: 100.00 }], 
  ethereum: [{ symbol: "ETH", name: "Ethereum", price: 3806.46 }] 
};
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex space-x-6">
            <button 
              className={`text-lg font-medium ${activeTab === 'Swap' ? 'text-white' : 'text-gray-400'}`}
              onClick={() => setActiveTab('Swap')}
            >
              Swap
            </button>
            <button 
              className={`text-lg font-medium ${activeTab === 'Limit' ? 'text-white' : 'text-gray-400'}`}
        ...
        <div className="bg-gray-800 rounded-xl p-4 mb-1">
          <div className="flex justify-between items-center mb-3">
            ...
            <input className="text-white text-l font-medium py-1 bg-transparent w-20 text-right" placeholder="Amount to Swap" value={fromAmount} onChange={(e) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span className="text-gray-400 text-sm">on {fromToken.name}</span>
              </div>
            </div>
            <div className="text-right">
              <div className="text-gray-400 text-sm">{fromChain}</div>
              <div className="text-gray-400 text-sm">$ {fromToken.price * fromAmount}</div>
            </div>
          </div>
        </div>
       ...
       <div className="bg-gray-800 rounded-xl p-4 mb-5">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-white text-l font-medium py-1 bg-transparent w-20 text-right">{toAmount}</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <div className="text-gray-400 text-sm">$ {toToken.price * toAmount}</div>
            </div>
          </div>
        </div>
